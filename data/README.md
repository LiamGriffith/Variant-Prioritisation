...
# Remaking VCFs
All vcfs made previously incorrectly contained all samples, to remake these, multi_sample_vcf.sh and gmulti_sample_vcf.sh were run to create single sample vcfs.  
